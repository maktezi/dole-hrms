                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    {{-- <select name="application_id" class="form-select">
                                                                        <option text="center" value="">Select from Database</option>
                                                                        <?php
                                                                    ...
                                                                    <select name="application_id" class="form-select">
                                                                            ...
                                                                            <option value="1">Admin Assistant I</option>
                                                                            <option value="2">Labor Employment Officer I</option>
                                                                            <option value="3">Senior LEO</option>
                                                                            <option value="4">Supply Officer I</option>
                                                                            <option value="5">Supervising LEO</option>
                                                                            <option value="6">Chief LEO</option>
                                                                      </select>
